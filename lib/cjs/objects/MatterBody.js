...
class MatterBody extends GlobalObject_1.GlobalObject {
    constructor(theOptions) {
        ...
        this.myID = MatterObjects_1.MatterObjects.bodyID;
    ...
    update() {
        if (!this.growComplete) {
            ...
            scaleBody_1.scaleBody(this.body, this.toScaleX, this.toScaleY, this.point);
            if (this.animSteps === 0) {
                this.growComplete = true;
            }
        }
